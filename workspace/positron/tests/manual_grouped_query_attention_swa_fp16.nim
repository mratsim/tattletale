...
##   --outdir:build/wip --nimcache:nimcache/wip workspace/positron/tests/manual_grouped_query_attention_swa_fp16.nim
...
import ../src/kernels/ceramic/attn_ssm/grouped_query_attention_swa
