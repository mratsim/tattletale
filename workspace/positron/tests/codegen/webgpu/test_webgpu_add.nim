...
##     workspace/positron/tests/codegen/webgpu/test_webgpu_add.nim
##
...
when defined(webgpu):
  ...
  echo "---"
  echo "To run execution tests, recompile with -d:webgpu"
  echo "After installing: nim c -r workspace/positron/vendor/wgpu_installer.nim"
