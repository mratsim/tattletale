...
##   --outdir:build/wip --nimcache:nimcache/wip workspace/positron/tests/manual_multi_head_latent_attention_prefill_fp16.nim
...
import ../src/kernels/ceramic/attn_ssm/multi_head_latent_attention_prefill
