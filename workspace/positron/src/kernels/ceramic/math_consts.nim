...
const fp32Lowest* = -3.402823466e38'f32
  ## -float32 max, the selection machines' mask value, a selected expert's
  ## score is overwritten with it and no later pass can match the masked cell.

const InvSqrt2Pi* = 0.7978845608028654'f32
  ## sqrt(2/pi), the factor of the gelu_pytorch_tanh spelling,
