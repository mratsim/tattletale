...
##
## Minimal Nim bindings for the Vulkan API subset needed for compute shaders.
## Dynamically linked via libvulkan.so.1.
...
const
  ...
  # Structure types — actual Vulkan spec values
  ...
  VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO* = VkStructureType(13)
  VK_STRUCTURE_TYPE_FENCE_CREATE_INFO* = VkStructureType(14)
  VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_INFO* = VkStructureType(22)
  VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO* = VkStructureType(23)
  VK_STRUCTURE_TYPE_BUFFER_MEMORY_REQUIREMENTS_INFO_2* = VkStructureType(29)
  VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET* = VkStructureType(30)
  ...
  VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO* = VkStructureType(44)
  VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO* = VkStructureType(45)
  VK_STRUCTURE_TYPE_MAPPED_MEMORY_RANGE* = VkStructureType(49)
  VK_STRUCTURE_TYPE_COPY_BUFFER_INFO* = VkStructureType(78)
  VK_STRUCTURE_TYPE_BUFFER_COPY* = VkStructureType(79)
  ...
  VK_MEMORY_PROPERTY_HOST_CACHED_BIT* = VkMemoryPropertyFlagBits(1 shl 3)
  ...
  VK_QUEUE_TRANSFER_BIT* = VkQueueFlags(1 shl 2)
...
# ═══════════════════════════════════════════════════════════════════════
# Structure types (simplified — only fields we need)
# ═══════════════════════════════════════════════════════════════════════
