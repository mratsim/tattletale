#!/usr/bin/env python3
"""Tier-03 full-forward-to-logits fixture generator, Mistral-7B-v0.1,
...
- embed through all 32 decoder layers plus the final norm and lm_head, one boundary slice layer-<i>.safetensor per layer
- the metadata rows carry the layer identity and the all-sliding shape
...
- at the 4-token prompt length the sliding mask skips to the sdpa is_causal path (mask None)
