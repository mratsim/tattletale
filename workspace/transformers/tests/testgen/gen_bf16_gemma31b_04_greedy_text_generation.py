...
Run from the worktree root
  ...
  uv run python workspace/transformers/tests/testgen/gen_bf16_gemma31b_04_greedy_text_generation.py
...
_ids = _load_sibling("gen_bf16_gemma31b_03_full_forward_to_logits.py")
