...
Reference: gen_bf16_03_layer_fixtures_Qwen3-0.6B.py conventions.
...
Consumed by tests/q_bf16/t_bf16_qwen35dense_02_attn.nim (attn-*, norm-*) and
t_bf16_qwen35dense_01_rope.nim (rope-*). No Qwen3 analog: Qwen3.5 interleaves
...
if not VENDORED_SRC or not os.path.isdir(VENDORED_SRC):
    raise SystemExit(
        "[gen_bf16_02_attn_fixtures_Qwen3.5-0.8B] set QWEN35_VENDORED_SRC to the src directory of the pinned transformers "
