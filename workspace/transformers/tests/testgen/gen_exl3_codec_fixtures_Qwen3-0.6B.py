...
Usage:
  ...
  python testgen/gen_exl3_codec_fixtures_Qwen3-0.6B.py

  # Use production EXL3 reconstruct (requires compiled exllamav3_ext)
  python testgen/gen_exl3_codec_fixtures_Qwen3-0.6B.py --backend exllamav3

  # Run both and compare (verification mode)
  python testgen/gen_exl3_codec_fixtures_Qwen3-0.6B.py --backend both --check

  # Only test a specific layer
  python testgen/gen_exl3_codec_fixtures_Qwen3-0.6B.py --layer 8 --proj q_proj

  # Dry-run: just decode one tile, no fixture files
  python testgen/gen_exl3_codec_fixtures_Qwen3-0.6B.py --dry-run

  # Verify decoder consistency against production kernel
  python testgen/gen_exl3_codec_fixtures_Qwen3-0.6B.py --verify

  # Verify decoder against original FP16 weights
  python testgen/gen_exl3_codec_fixtures_Qwen3-0.6B.py --verify-fp16
"""
