#!/usr/bin/env python3
"""Tier-04 greedy-text-generation fixture generator, gemma-4-E2B-it,
...
- the third prompt prefill-crosses the 512 sliding window, the full layers and the shared kv layers see the whole context
