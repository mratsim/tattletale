#!/usr/bin/env python3
"""Greedy-text-generation fixtures of the gemma-4-E2B-it checkpoint:
token chains argmax-decoded through the installed transformers modeling,
torch bf16, Metal (mps).

- fixture dir tests/fixtures/bf16-04-greedy-text-generation/gemma-4-E2B-it/
- consumer tests/q_bf16/t_bf16_gemma4e2b_04_greedy_text_generation.nim
...
the full layers and the shared kv layers see the whole context.
...
Run from the worktree root
  ...
  uv run python workspace/transformers/tests/testgen/gen_bf16_gemma4e2b_04_greedy_text_generation.py
...
_ids = _load_sibling("gen_bf16_gemma4e2b_03_full_forward_to_logits.py")
...
def main() -> None:
    ...
    for prompt_text, max_new_tokens, fixture_name in PROMPT_SPEC:
        ...
        fixture = {
            ...
            "env": recording_env(
                model=MODEL_NAME,
                generator="testgen/gen_bf16_gemma4e2b_04_greedy_text_generation.py",
