...
from fixture_stats import write_stats_file
from fixture_exl3_common import reconstruct_orig_exl3
from exllamav3.ext import exllamav3_ext as ext

DEVICE = 'cuda:0'
BASE = os.path.join(os.path.dirname(__file__), '..')
FIXTURE_DIR = os.path.join(BASE, 'fixtures', 'exl3-01-block-02-trace')
...
fix=st_load(os.path.join(BASE,'fixtures','exl3-03-full-forward-to-logits','Qwen3-0.6B-EXL3-5bpw','layer-02.safetensor'),device=DEVICE)
