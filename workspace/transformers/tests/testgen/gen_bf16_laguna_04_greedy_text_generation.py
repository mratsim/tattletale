#!/usr/bin/env python3
"""Tier-04 greedy-text-generation fixture generator, Laguna-XS-2.1,
...
- a chain pick equal to a configured eos id (2 or 24) fails the run, every recorded pick stays a live argmax pick
- the third prompt prefill-crosses the 512 sliding window, the sliding layers record the windowed-mask path over the grown cache
