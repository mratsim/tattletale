...
Reference: gen_bf16_02_attn_fixtures_Qwen3.5-0.8B.py conventions.

Consumed by tests/q_bf16/t_bf16_qwen35dense_03_layers.nim (gdn-* and the full
layer-* arms) and t_bf16_qwen35dense_04_long_residual_3_blocks.nim (the 3-block
chain). No Qwen3 analog: GatedDeltaNet is the SSM (linear-attention)
...
if not VENDORED_SRC or not os.path.isdir(VENDORED_SRC):
    raise SystemExit(
        "[gen_bf16_02_gdn_fixtures_Qwen3.5-0.8B] set QWEN35_VENDORED_SRC to the src directory of the pinned transformers "
