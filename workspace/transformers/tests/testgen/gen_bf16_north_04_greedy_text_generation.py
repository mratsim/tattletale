#!/usr/bin/env python3
"""Tier-04 greedy-text-generation fixture generator, North-Mini-Code-1.0,
...
- every decode runs the eager expert loop over all 48 routed layers, prompt one reuses the token ids recorded in the bf16-03 family
