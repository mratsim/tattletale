#!/usr/bin/env python3
"""Tier-01 boundary-pair fixture generator, gemma-3-1b-it,
torch bf16 on Metal (mps) under the installed reference modeling,

- consumer tests/q_bf16/t_bf16_gemma31b_01_layer_internals.nim
...
- fixture dir tests/fixtures/bf16-01-layer-internals/gemma-3-1b-it-layer-4-5/, file layer4-5-gemma-3-1b-it-00.safetensor
