#!/usr/bin/env python3
"""Tier-03 full-forward-to-logits fixture generator, gemma-4-12B-it,
...
- embed through all 48 decoder layers plus the final norm and lm_head, one boundary slice layer-<i>.safetensor per layer
- the metadata rows carry the layer kind, the dual head dims and the k_eq_v row
...
- the 3-token prompt keeps the per-layer payloads inside the 1.5 MiB family dir budget over the 48 layers
