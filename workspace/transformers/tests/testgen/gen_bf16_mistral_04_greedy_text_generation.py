#!/usr/bin/env python3
"""Tier-04 greedy-text-generation fixture generator, Mistral-7B-v0.1,
...
- the third prompt prefill-crosses the 4096 sliding window, 5042 prompt tokens, decode runs on the sliding mask over the grown cache
