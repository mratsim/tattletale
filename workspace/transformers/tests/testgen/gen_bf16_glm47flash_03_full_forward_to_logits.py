...
_moe_fixtures = _load_sibling("gen_bf16_glm47flash_01_layer_internals.py")
...
def build_model(weight_map: dict) -> Glm4MoeLiteForCausalLM:
    ...
    # - the strict keep-in-fp32 policy of the reference class applies
    #   even on a bf16 deploy, the measured dtype plan keeps the selection-bias buffer
    #   in torch.float32, the live buffer equals the checkpoint values on all 64/64 entries at layer 1
