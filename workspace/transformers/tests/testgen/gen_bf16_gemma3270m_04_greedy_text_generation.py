#!/usr/bin/env python3
"""Tier-04 greedy-text-generation fixture generator, gemma-3-270m-it,
...
- the third prompt prefill-crosses the 512 sliding window, 622 prompt tokens, the decode steps run on the bounded sliding cache
