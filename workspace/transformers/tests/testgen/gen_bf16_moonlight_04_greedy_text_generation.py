...
- fixture dir tests/fixtures/bf16-04-greedy-text-generation/Moonlight-16B-A3B/
- consumer tests/q_bf16/t_bf16_moonlight_04_greedy_text_generation.nim
...
Run from the worktree root
  uv run python workspace/transformers/tests/testgen/gen_bf16_moonlight_04_greedy_text_generation.py
"""
import argparse
import hashlib
import json
...
_ids_inference = _load_sibling("gen_bf16_moonlight_03_full_forward_to_logits.py")
...
#   against the tiktoken Rust engine
...
def main() -> None:
    ...
    for prompt_text, max_new_tokens in PROMPT_SPEC:
        ...
        fixture = {
            ...
            "env": recording_env(
                model=MODEL_NAME,
                generator="testgen/gen_bf16_moonlight_04_greedy_text_generation.py",
