...
Usage:
    cd tattletale
    .venv/bin/python workspace/transformers/tests/testgen/gen_bf16_04_3_long_residual_3_blocks_Qwen3-0.6B.py
"""
import torch
...
def main():
    ...
    print("  The invariant is tested in t_bf16_qwen3_04_long_residual_3_blocks.nim")
