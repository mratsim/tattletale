...
## nim cpp -r --hints:off --warnings:off --outdir:build/tests/qwen35dense-attn \
##   --nimcache:nimcache/tests/qwen35dense-attn \
##   workspace/transformers/tests/q_bf16/t_bf16_qwen35dense_02_attn.nim
