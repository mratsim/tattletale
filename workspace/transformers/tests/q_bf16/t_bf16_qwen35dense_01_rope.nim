...
## nim cpp -r --hints:off --warnings:off --outdir:build/tests/qwen35dense-rope \
##   --nimcache:nimcache/tests/qwen35dense-rope \
##   workspace/transformers/tests/q_bf16/t_bf16_qwen35dense_01_rope.nim
