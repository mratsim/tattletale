...
## nim cpp -r --hints:off --warnings:off --outdir:build/tests/qwen35dense-t2t \
##   --nimcache:nimcache/tests/qwen35dense-t2t \
##   workspace/transformers/tests/q_bf16/t_bf16_qwen35dense_06_t2t_inference.nim
