...
## Greedy (temp=0) decoding of the Qwen3-0.6B stack, the recorded chains
...
##     --outdir:build/par-b --nimcache:nimcache/par-b workspace/transformers/tests/q_bf16/t_bf16_qwen3_04_greedy_text_generation.nim
