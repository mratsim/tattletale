...
##
## Fixtures generated by gen_bf16_04_3_long_residual_3_blocks_Qwen3-0.6B.py contain ALL intermediates
  ...
  runCppTest "Qwen3 long residual stream - intermediate verification (3 blocks)":
    proc(): bool =
      ...
      for layerIdx in 0..2:
        ...
        block:
          # ── Manual reimplementation of the decoder-block forward ──
          # This matches the forward() method in decoder_layers.nim exactly.
          ...
          # Step 2: attention
          let attn_out = layer.sequence_mixer(ctx, h)
          ...
          # Step 4: mlp
          let mlp_out = layer.hidden_mixer(h2_norm)
        ...
        block:
          # ── Call the real block forward and verify it matches ──
          ctx.kv_position = 0
