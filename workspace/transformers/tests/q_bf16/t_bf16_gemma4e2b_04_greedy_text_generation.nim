...
## Greedy (temp=0) decoding of the gemma-4-E2B-it stack, the recorded chains
...
##     --outdir:build/tests --nimcache:nimcache/tests workspace/transformers/tests/q_bf16/t_bf16_gemma4e2b_04_greedy_text_generation.nim
...
const
  ...
  FixtureDir = currentSourcePath().parentDir() / ".." / "fixtures" /
    "bf16-04-greedy-text-generation" / "gemma-4-E2B-it"
  GreedyFixtureFiles = [
...
when isMainModule:
  runCppTest("gemma-4-E2B greedy text generation", main)
