## WebGPU: `+`/`*` on Int[N] with compile-time and dynamic int operands
##
...
##   --outdir:build/tests/webgpu --nimcache:nimcache/tests/webgpu \
##   workspace/crucible/tests/codegen/webgpu/test_webgpu_static_int_ops.nim
import std/[unittest]
