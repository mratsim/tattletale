...
## Metal anti-regression, gid scalar probe.
##
...
##     workspace/crucible/tests/codegen/metal/test_metal_anti_regression_gid_scalar.nim
...
proc runTest() =
  ...
  echo "anti-regression gid scalar: OK"
