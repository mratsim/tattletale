## CUDA (NVRTC) generic device procs instantiated at multiple
...
##
## Run:
##   nim cpp -r --outdir:build/tests --nimcache:nimcache/tests workspace/crucible/tests/codegen/nvrtc/test_nvrtc_generic_inst_dedup.nim
...
proc runTest() =
  suite "CUDA via NVRTC - generic device proc static-param instantiations":
