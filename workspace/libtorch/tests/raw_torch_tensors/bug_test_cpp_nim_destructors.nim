...
# Blocked by
# - https://github.com/nim-lang/Nim/issues/25800 - [C++] =wasMoved + {.importcpp: #.foo().} does not replace #
# - https://github.com/nim-lang/Nim/issues/25803 - [C++] default(T) initializer list may lead to ambiguous assignment and prevent compilation
