...
macro genBinOp(op: untyped): untyped =
  result = newStmtList()
  result.add quote do:
    template `op`[V, U: static int](a: Int[V]; b: Int[U]): auto =
      Int[`op`(V, U)]()
    func `op`[V: static int](a: Int[V]; b: static int): auto {.inline.} =
      Int[`op`(V, b)]()
    func `op`[V: static int](a: static int; b: Int[V]): auto {.inline.} =
      Int[`op`(a, V)]()
