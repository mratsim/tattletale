...
doAssert coords(tiled2.partitionC((32, 16), 0)).sorted == @[(0,0),(0,1),(8,0),(8,1)]
doAssert coords(tiled2.partitionC((32, 16), 1)).sorted == @[(0,2),(0,3),(8,2),(8,3)]
doAssert coords(tiled2.partitionC((32, 16), 32)).sorted == @[(16,0),(16,1),(24,0),(24,1)]
doAssert coords(tiled2.partitionC((32, 16), 64)).sorted == @[(0,8),(0,9),(8,8),(8,9)]
doAssert coords(tiled2.partitionA((32, 8), 0)).sorted == @[(0,0),(0,4),(8,0),(8,4)]
doAssert coords(tiled2.partitionA((32, 8), 5)).sorted == @[(1,1),(1,5),(9,1),(9,5)]
doAssert coords(tiled2.partitionB((16, 8), 0)).sorted == @[(0,0),(0,4)]
doAssert coords(tiled2.partitionB((16, 8), 5)).sorted == @[(1,1),(1,5)]
